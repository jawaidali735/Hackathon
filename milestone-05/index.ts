...
@media (max-width: 768px) {
    ...
    #download-link-container h2 {
        font-size: 20px;
            ...
            const resumeOutput = document.getElementById('outer-bodyT')?.innerHTML || '';
            ...
            const username = usernameElement?.value.trim() || "user";
            ...
            const downloadLinkContainer = document.getElementById('download-link') as HTMLDivElement;
...
let outer = document.getElementById('outer-body') as HTMLElement;
let outerT = document.getElementById('outer-bodyT') as HTMLElement;
let editButton = document.getElementById('editable') as HTMLElement;
